<template>
  <div class="min-h-screen flex flex-col bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500">
    <!-- Conteúdo Principal -->
      ...
      <div class="card w-full max-w-md bg-base-100 shadow-2xl">
        <div class="card-body">
          ...
          <div class="text-center mb-8">
            ...
            <h1 class="text-4xl font-bold text-primary mb-2">ReservationSystem</h1>
          ...
          <form @submit.prevent="fazerCadastro" class="space-y-4">
            ...
            <div class="form-control">
              ...
              <div class="relative">
                ...
                >
                  <svg v-if="!mostrarConfirmarSenha" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                  </svg>
                  <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <!-- Rodapé Completo -->
    <footer class="bg-white/10 backdrop-blur-md text-white border-t border-white/20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p class="text-sm opacity-90 mb-4">
              Sistema completo de gerenciamento de reservas. Facilite o agendamento e organização do seu estabelecimento.
            </p>
            <div class="flex gap-3">
              <a href="https://instagram.com" target="_blank" class="btn btn-circle btn-sm bg-white/20 hover:bg-pink-500 border-0">
              ...
              <a href="https://wa.me/5585999999999" target="_blank" class="btn btn-circle btn-sm bg-white/20 hover:bg-green-500 border-0">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://t.me/reservationsystem" target="_blank" class="btn btn-circle btn-sm bg-white/20 hover:bg-blue-500 border-0">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/>
                </svg>
              </a>
              <a href="https://facebook.com" target="_blank" class="btn btn-circle btn-sm bg-white/20 hover:bg-blue-600 border-0">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
