        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div class="flex gap-3">
              <a href="https://instagram.com" target="_blank" class="btn btn-circle btn-sm hover:bg-pink-800 border-0">
              ...
              <a href="https://facebook.com" target="_blank" class="btn btn-circle btn-sm hover:bg-blue-800 border-0">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
